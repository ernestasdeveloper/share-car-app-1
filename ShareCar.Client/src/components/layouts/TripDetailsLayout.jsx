                ...
                <div>
                    ...
                    <div className="trip-details-container gen-container">
                        <div className="trip-details">
                            ...
                            <Link className="gen-button gen-flex-row-item" to={"/trips/" + this.props.match.params.id + "/rides/driver"}>Rides</Link>
                            {/*PassengerID hardcoded into URL*/}
                            <Link className="gen-button gen-flex-row-item" to={"/trips/request/" + this.props.match.params.id + "/2"}>Request</Link>
                        </div>
                            </div>
                        </div>
